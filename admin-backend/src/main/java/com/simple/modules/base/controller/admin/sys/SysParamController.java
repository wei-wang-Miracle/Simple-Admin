...
public class SysParamController {
    ...
    @ApiOperation("新增")
    @PostMapping("/add")
    public RestResult add(@RequestBody SysParamEntity entity) {
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    public RestResult update(@RequestBody SysParamEntity entity) {
    ...
    public RestResult info(@RequestParam Long id) {
        return RestResult.ok(baseSysParamService.getById(id));
    }
    ...
    public RestResult page(@RequestBody Map<String, Object> params) {
        ...
        if (params.get("keyWord") != null) {
            ...
            wrapper.where(SysParamEntity::getName).like(keyWord)
                    .or(SysParamEntity::getKeyName).like(keyWord);
        }
        wrapper.orderBy(SysParamEntity::getCreateTime).desc();
